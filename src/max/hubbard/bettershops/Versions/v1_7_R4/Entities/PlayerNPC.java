...
import max.hubbard.bettershops.Versions.v1_7_R4.NPCConnection;
...
public class PlayerNPC extends EntityPlayer {
    ...
    public PlayerNPC(MinecraftServer minecraftserver, WorldServer worldserver, GameProfile gameprofile, PlayerInteractManager playerinteractmanager) {
        ...
        PacketPlayOutPlayerInfo pack = PacketPlayOutPlayerInfo.addPlayer(this);
        // AddPlayer",true,0 DEAD ARGS
        sendPacketsTo(Bukkit.getOnlinePlayers(), pack);
    }
